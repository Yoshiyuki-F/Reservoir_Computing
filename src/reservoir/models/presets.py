...
TIME_CLASSICAL_RESERVOIR_PRESET = PipelineConfig(
    ...
    projection=RandomProjectionConfig(
        n_units=400,
        input_scale=1.1808661406250922,#1.2019208858978183,
        input_connectivity=0.13588027912024847, #0.1928267681965625,
        bias_scale=1.0029669118717532, #0.9568959152230178,
        seed=1,
    ),
    model=ClassicalReservoirConfig(
        spectral_radius=1.616, #1.5972788236034943,
        leak_rate=0.41848915914774804, # 0.39768734461610455,
        rc_connectivity=0.677, # 0.9244981889173147,
        seed=42,
        aggregation=AggregationMode.SEQUENCE,
    ),
    readout=DEFAULT_RIDGE_READOUT
