...
class Flatten:
    ...
    @staticmethod
    def transform(X: JaxF64, log_label: str | None = None, _params: KwargsDict | None = None) -> JaxF64:
        if X.ndim == 3:
    ...
    @staticmethod
    def align_targets(targets: JaxF64, log_label: str | None = None, _params: KwargsDict | None = None) -> JaxF64:
    ...
    def __call__(self, X: JaxF64, log_label: str | None = None, _params: KwargsDict | None = None) -> JaxF64:
        return self.transform(X, log_label=log_label, _params=_params)
...
class TimeDelayEmbedding:
    ...
    def transform(self, X: JaxF64, flatten_batch: bool = True, log_label: str | None = None, _params: KwargsDict | None = None) -> JaxF64:
    ...
    def align_targets(self, targets: JaxF64, log_label: str | None = None, _params: KwargsDict | None = None) -> JaxF64:
    ...
    def __call__(self, X: JaxF64, flatten_batch: bool = True, log_label: str | None = None, _params: KwargsDict | None = None) -> JaxF64:
        return self.transform(X, flatten_batch=flatten_batch, log_label=log_label, _params=_params)
